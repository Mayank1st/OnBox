...
import sendEmailModel from "../models/SendEmail.js";
class UserController {
  ...
  // Send Data
  static sendData = async (req, res) => {
    console.log("Hello");
    const { sendingTo, sendingFrom, subject, message } = req.body;
    console.log(req.body);

    // All fields are required
    if (!sendingTo || !sendingFrom || !subject || !message) {
    ...
    try {
      ...
      let mailOptions = {
        ...
        subject: subject,
        text: message,
        html: `<p><strong>From:</strong> ${sendingFrom}</p>
               <p><strong>To:</strong> ${sendingTo}</p>
      ...
      const emailRecord = new sendEmailModel({
        sendingTo,
        sendingFrom,
        subject,
        message,
